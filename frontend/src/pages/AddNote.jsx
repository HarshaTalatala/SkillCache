          ...
          <div className="space-y-2">
            {isPreview ? (
              ...
              <textarea
                ...
                className="w-full min-h-[500px] p-6 bg-card rounded-lg border border-border/50 resize-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-foreground placeholder:text-muted-foreground"
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {formData.attachments.map((attachment) => (
                  <div key={attachment.id} className="flex items-center gap-3 p-3 bg-card rounded-lg border border-border/50">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="nothing-btn-ghost flex items-center justify-center gap-1 text-sm py-2 px-2 min-w-0"
            >
              {isPreview ? <Edit3 className="w-3 h-3" /> : <Eye className="w-3 h-3" />}
              <span className="truncate text-xs">{isPreview ? 'Edit' : 'View'}</span>
            </button>
            
            <button
              onClick={handleSubmit}
              disabled={isLoading || !formData.title.trim()}
              className="nothing-btn-primary flex items-center justify-center gap-1 flex-1 py-2 px-3"
            >
              <Save className="w-4 h-4" />
              <span className="truncate text-base font-semibold">{isLoading ? 'Saving...' : 'Save'}</span>
            </button>
          </div>
