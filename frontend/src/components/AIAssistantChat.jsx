    ...
    <div className="flex flex-col h-full sm:min-h-0 min-h-screen bg-background overflow-hidden overflow-x-hidden flex-1 min-w-0 px-4 sm:px-8">
      <div className="flex flex-col h-full w-full flex-1">
        <div className="flex flex-col h-full w-full max-w-3xl mx-auto">
          {/* Header */}
          <div className="flex items-center justify-between gap-2 sm:gap-3 px-3 sm:px-6 py-3 sm:py-4 border-b border-border/30 bg-background/80 relative">
            <div className="flex items-center gap-2 sm:gap-3">
              <Bot className="text-primary" size={32} />
              <span className="font-semibold text-lg sm:text-xl">AI Assistant</span>
            </div>
            <button
              type="button"
              className="flex items-center justify-center p-2 rounded-full bg-primary/10 text-primary border border-primary/30 hover:bg-primary/20 focus:ring-2 focus:ring-primary/40 transition-colors"
          ...
          {/* Messages */}
          <div className="flex-1 min-h-0 overflow-y-auto py-4 sm:py-6 space-y-3 sm:space-y-4 bg-background/90 pb-16 sm:pb-0">
            {messages.map((msg, idx) => (
              ...
              >
                <div
                  className={`max-w-[80%] px-4 py-2 rounded-2xl text-base shadow-sm ${
                    msg.role === 'user'
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="flex items-center gap-2 bg-zinc-100 dark:bg-zinc-800 text-foreground px-4 py-2 rounded-2xl rounded-bl-md shadow-sm">
          ...
          <form
            onSubmit={handleSend}
            className="p-2 border-t border-border/30 bg-background flex gap-2 mb-0 fixed bottom-0 left-0 w-full z-20 sm:hidden max-w-3xl mx-auto"
          ...
          >
            ...
            <button
              type="submit"
              className="bg-primary text-white px-3 py-2 rounded-full font-semibold hover:bg-primary/90 transition-colors disabled:opacity-60 text-sm"
          ...
          {showNoteModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
              <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6 w-full max-w-md mx-auto">
                ...
                <button
                  className="mt-2 px-4 py-2 rounded-lg bg-zinc-200 dark:bg-zinc-700 text-zinc-800 dark:text-zinc-100 hover:bg-zinc-300 dark:hover:bg-zinc-600 transition-colors"
          ...
          {showHistoryModal && (
            <div className="fixed inset-0 z-50 flex">
              ...
              <div className="relative ml-auto h-full w-full sm:max-w-md bg-white dark:bg-zinc-900 shadow-2xl flex flex-col max-h-screen animate-slide-in-right">
